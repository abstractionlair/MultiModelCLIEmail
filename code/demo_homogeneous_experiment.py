"""
demo_homogeneous_experiment.py

Phase 1 Experiment: Demonstrate evaluator gaming with homogeneous TriggerWordEvaluator ensemble.

Tests if QD search can exploit a deliberately gameable evaluator when all judges are identical.
...
def run_homogeneous(
    ...
    output_file: str = "experiment_results_homogeneous.json"
):
    """Run Homogeneous: All TriggerWordEvaluator experiment."""
    
    print("=" * 70)
    print("HOMOGENEOUS: All TriggerWordEvaluator Ensemble")
...
if __name__ == '__main__':
    ...
    output = sys.argv[2] if len(sys.argv) > 2 else "experiment_results_homogeneous.json"
