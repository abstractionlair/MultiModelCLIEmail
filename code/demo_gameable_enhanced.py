"""
demo_gameable_enhanced.py

Phase 1 Experiment with Enhanced Mutator: Demonstrate evaluator gaming with TriggerWordEvaluator.
...
def run_condition_a(
    ...
    output_file: str = "experiment_results_enhanced_heterogeneous.json"
):
    """Run Condition A: Vulnerable ensemble experiment with enhanced mutator."""
    
    print("=" * 70)
    print("CONDITION A: Vulnerable Ensemble with Enhanced Mutator")
    ...
    results = {
        'condition': 'A_vulnerable_enhanced',
...
if __name__ == '__main__':
    ...
    output = sys.argv[2] if len(sys.argv) > 2 else "experiment_results_enhanced_heterogeneous.json"
